...
workflow {
  ...
  ///////////////////////////////////////////////////////////////////////////
  BAMBU(samples.collect(), ref_gtf, ref_fa)
  BAMBU_SPLIT_RESULTS(BAMBU.out.bambu_gtf)

  ///////////////////////////////////////////////////////////////////////////
  // EXTRACT AND CLASSIFY NEW TRANSCRIPTS, AND PERFORM QC
  ///////////////////////////////////////////////////////////////////////////
  FEELNC_CODPOT(ref_gtf, ref_fa, BAMBU_SPLIT_RESULTS.out.novel_genes)
  FEELNC_FORMAT(FEELNC_CODPOT.out.mRNA, FEELNC_CODPOT.out.lncRNA)
  RESTORE_BIOTYPE(ref_gtf, BAMBU_SPLIT_RESULTS.out.novel_isoforms)
  MERGE_NOVEL(FEELNC_FORMAT.out, RESTORE_BIOTYPE.out)

  QC_FULL(samples, INDEX_BAM.out, MERGE_NOVEL.out, ref_gtf, BAMBU.out.gene_counts, "full")
  ...
  if(params.filter) {
    ...
    QC_FILTER(samples, INDEX_BAM.out, TFKMERS.out.gtf, ref_gtf, BAMBU.out.gene_counts, "filter")
  }
}
